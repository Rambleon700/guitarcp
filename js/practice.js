...
function startCustomExercise() {
  ...
  if (typeof renderStrumArrows === "function") renderStrumArrows(strumPattern);
  ...
  function step() {
    ...
    loadChord(chord);
    if (typeof highlightStrumStep === "function") highlightStrumStep(strokeIndex % strumPattern.length);
...
function stopPracticeSession() {
  ...
  if (typeof highlightStrumStep === "function") highlightStrumStep(-1);
